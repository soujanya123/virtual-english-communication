...
mysql_select_db ("$db");
$stuff = mysql_query("SELECT * FROM `menu1` WHERE cid='".$course_id."'") or die("MySQL Login Error: ".mysql_error()); 
...
echo "<li><a href=\"view3.php?link=$tid\"><span><center><img src=\"images/$pic\" BORDER=0><br>$cap</center></span></a></li>\n";
  }	
...
mysql_select_db ("$db");
$stuff = mysql_query("SELECT * FROM `content1` WHERE cid='".$course_id."' AND tid='".$tab_id."' ORDER BY srno ASC" ) or die("MySQL Login Error: ".mysql_error()); 
